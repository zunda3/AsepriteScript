...
local ListFilePath = app.fs.userConfigPath.."scripts/list.tsv"
...
if f == nil then
  --  app.alert{title="LayerNameChange in Selection Script", text="レイヤ名のリストファイルが見つかりません。「list.tsv」というファイル名でスクリプト保管先に保管してください。 例: C:/Users/zunda3team/AppData/Roaming/Aseprite/scripts/list.tsv"}
   app.alert('Layer name list file is not found. Please save "list.tsv" in script directory.  e.g. C:/Users/zunda3team/AppData/Roaming/Aseprite/scripts/list.tsv')
   return 1
end
