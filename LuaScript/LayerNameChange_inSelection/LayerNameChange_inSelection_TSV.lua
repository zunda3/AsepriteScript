...
--スクリプトフォルダ内にあるlist.tsvを取得する。
--例：C:/Users/zunda3team/AppData/Roaming/Aseprite/scripts/list.tsv
local f = io.open(app.fs.userConfigPath..'scripts/list.tsv', 'r')

--ファイルが見つからない場合はエラーで閉じる。
if f == nil then
   app.alert('Layer name list file is not found. Please save "list.tsv" in script directory.  Example: C:/Users/zunda3team/AppData/Roaming/Aseprite/scripts/list.tsv')
   return nil
end
